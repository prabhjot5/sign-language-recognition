...
st.sidebar.title('Sign Language Detection - prabhjot singh')
...
if app_mode =='About App':
    ...
    st.video('https://www.youtube.com/watch?v=t7Rb9YUzpi4&ab_channel=TEDxTalks')
    st.markdown('''
              # About Me \n 
                Hey this is **prabhjot singh**. Working on the technologies such as **Tensorflow, MediaPipe, OpenCV**. \n

                Also check me out on Social Media
                - [YouTube](https://www.youtube.com/watch?v=jaVdD4Z8UCs&ab_channel=SidhuMooseWala)
                - [LinkedIn](https://www.linkedin.com/in/prabhjot-singh-40227220b/)
                - [GitHub](https://github.com/prabhjot5)
